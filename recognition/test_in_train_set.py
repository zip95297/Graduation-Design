...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load("../checkpoints/ckpt-recognition/teacher_now.pth", map_location=conf.device))
    model.eval()

    images = unique_image("/home/zjb/workbench/data/webface_test_pair.txt")
    images = [osp.join("/home/zjb/workbench/data/CASIA-WebFace", img) for img in images]
    ...
    accuracy, threshold = compute_accuracy(feature_dict, "/home/zjb/workbench/data/webface_test_pair.txt", "/home/zjb/workbench/data/CASIA-WebFace") 
