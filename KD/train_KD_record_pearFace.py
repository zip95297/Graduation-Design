#maybe teacher should be train with metric pearFace

import torch
import torchvision.transforms as T
from models import ResIRSE,ResNet18,loss
from models.metric import ArcFace , PearFace
from config import config as conf
from dataset import load_data
from models.KD_loss_record import KD_loss
from models.KD_loss_PearFace import KD_loss_PearFace
...
criterion = KD_loss_PearFace(class_num, T=2, alpha=1, beta=15, gamma=1.0, embedding_size=embedding_size).to(device)
