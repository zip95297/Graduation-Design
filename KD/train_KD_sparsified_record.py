...
print(f"resnet18 config: {r18_config}")
...
for epoch in range(conf.epoch):
    ...
    conf.student_ckpt = "/home/zjb/workbench/checkpoints/ckpt-prune/channel-prune"
    backbone_path = osp.join(conf.student_ckpt, f"_record_Resnet18_pruned_{epoch}_{acc:.3f}_{loss:.4f}.pth")
