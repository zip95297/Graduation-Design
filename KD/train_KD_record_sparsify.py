...
from models.resnet18_to_sparsify import ResNet18_to_Sparsify
...
print(f"Training Sparsify_KD {conf.student_model} with {conf.metric} with {conf.epoch} epochs and {conf.train_batch_size} batch size and optimizer {conf.KD_optimizer}")
...
for epoch in range(conf.epoch):
    ...
    backbone_path = osp.join("../checkpoints/ckpt-KD/Sparsify", f"_record_Resnet18_Sparsify_{epoch}_{acc:.3f}_{loss:.4f}.pth")
